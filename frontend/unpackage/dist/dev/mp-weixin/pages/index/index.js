...
/***/ 33:
/*!**************************************************************************************************************************!*\
  !*** /Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**************************************************************************************************************************/
...
/***/ 34:
/*!*******************************************************************************************************!*\
  !*** /Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/pages/index/index.vue ***!
  \*******************************************************************************************************/
/*! no static exports found */
...
/***/ 35:
/*!**************************************************************************************************************************************!*\
  !*** /Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**************************************************************************************************************************************/
...
var render = function () {
  ...
  var m0 = _vm.showAmount ? _vm.formatMoney(_vm.monthExpense) : null
  var m1 = _vm.showAmount ? _vm.formatMoney(_vm.monthIncome) : null
  var m2 = _vm.showAmount ? _vm.formatMoney(_vm.monthBalance) : null
  var m3 = _vm.budget > 0 ? _vm.formatMoney(_vm.budget) : null
  var m4 =
    _vm.budget > 0 && _vm.budgetRemain >= 0
  ...
  var m5 =
    _vm.budget > 0 && !(_vm.budgetRemain >= 0)
      ...
      : null
  var g0 = _vm.todayRecords.length
  var l0 =
    g0 > 0
      ? _vm.__map(_vm.todayRecords, function (item, __i0__) {
...
/***/ 37:
/*!********************************************************************************************************************************!*\
  !*** /Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/pages/index/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 38:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  computed: {
    ...
    greetingEmoji: function greetingEmoji() {
      var hour = new Date().getHours();
      if (hour < 6) return '🌙';
      if (hour < 9) return '🌅';
      if (hour < 12) return '☀️';
    ...
    todayStr: function todayStr() {
      var now = new Date();
      var month = now.getMonth() + 1;
      var day = now.getDate();
      var weekDays = ['日', '一', '二', '三', '四', '五', '六'];
      return "".concat(month, "\u6708").concat(day, "\u65E5 \u5468").concat(weekDays[now.getDay()]);
    },
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var res, data, today, _iterator, _step, day;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                res = _context.sent;
                data = res.data;
                _this.monthIncome = data.totalIncome || 0;
                _this.monthExpense = data.totalExpense || 0;
                _this.monthBalance = data.balance || 0;
                _this.budget = data.budget || 0;
                _this.budgetRemain = data.budgetRemain || 0;

                // 提取今日记录
                today = (0, _util.getCurrentDate)();
                _this.todayRecords = [];
                if (!data.dailyList) {
                  _context.next = 31;
                  break;
                }
                _iterator = _createForOfIteratorHelper(data.dailyList);
                _context.prev = 14;
                _iterator.s();
              case 16:
                ...
                _this.todayRecords = day.records || [];
        ...
        }, _callee, null, [[0, 33], [14, 25, 28, 31]]);
      }))();
    },
    toggleAmount: function toggleAmount() {
    ...
    onRecordLongPress: function onRecordLongPress(item) {
      ...
      uni.showActionSheet({
        ...
        success: function success(res) {
          if (res.tapIndex === 0) {
            uni.navigateTo({
              url: "/pages/add/add?id=".concat(item.id, "&edit=1")
            });
          } else if (res.tapIndex === 1) {
            _this2.doDeleteRecord(item);
          }
        }
      });
    },
    doDeleteRecord: function doDeleteRecord(item) {
      var _this3 = this;
      uni.showModal({
        title: '提示',
        content: '确定删除这条记录吗？',
...
/***/ 45:
/*!*****************************************************************************************************************************************!*\
  !*** /Users/zhangchuancun/Downloads/jizhangxiaochengxu/accounting-app/frontend/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
