...
var _default = {
  ...
  computed: {
    ...
    todayStr: function todayStr() {
      ...
      return "".concat(year, "\u5E74").concat(month, "\u6708").concat(day, "\u65E5 ").concat(weekDays[now.getDay()]);
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                res = _context2.sent;
                data = res.data;
                _this2.monthIncome = data.totalIncome || 0;
                _this2.monthExpense = data.totalExpense || 0;
                _this2.monthBalance = data.balance || 0;
                _this2.budget = data.budget || 0;
                _this2.budgetRemain = data.budgetRemain || 0;
              ...
              case 16:
                ...
                _this2.todayRecords = day.records || [];
              ...
              case 33:
                ...
                console.error('加载数据失败', _context2.t1);
              case 36:
              case "end":
                return _context2.stop();
            }
          }
        }, _callee2, null, [[0, 33], [14, 25, 28, 31]]);
      }))();
    },
