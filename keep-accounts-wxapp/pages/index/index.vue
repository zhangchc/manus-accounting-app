...
.page {
  min-height: 100vh;
  background: linear-gradient(180deg, #F4F6FC 0%, #FAFBFE 240rpx);
...
/* 本月概览卡片 - 蓝紫渐变 + Soft Glass 质感 */
.overview-card {
  background: linear-gradient(135deg, #7B9EF5 0%, #9BB0F7 40%, #B8A0F5 100%);
  border-radius: 28rpx;
  padding: 36rpx 32rpx 40rpx;
  color: #FFFFFF;
  box-shadow: 0 4rpx 8rpx rgba(91, 130, 224, 0.18), 0 16rpx 48rpx rgba(123, 158, 245, 0.32);
  position: relative;
  overflow: hidden;
}
...
.budget-section {
  ...
  border-radius: 20rpx;
  padding: 24rpx 28rpx;
  box-shadow: 0 1rpx 2rpx rgba(45, 49, 66, 0.04), 0 4rpx 16rpx rgba(123, 158, 245, 0.06);
}
...
.record-item {
  ...
  background: #FFFFFF;
  border-radius: 20rpx;
  box-shadow: 0 1rpx 2rpx rgba(45, 49, 66, 0.03), 0 4rpx 18rpx rgba(123, 158, 245, 0.06);
}
...
.empty-btn {
  ...
  box-shadow:
    ...
    0 6rpx 20rpx rgba(123, 158, 245, 0.3);
}
...
.fab-btn {
  ...
  box-shadow:
    ...
    inset 0 -2rpx 6rpx rgba(91, 130, 224, 0.25),
    0 8rpx 24rpx rgba(91, 130, 224, 0.32),
    0 16rpx 40rpx rgba(123, 158, 245, 0.36);
  z-index: 100;
}
...
.fab-btn:active {
  ...
  box-shadow:
    ...
    0 4rpx 12rpx rgba(91, 130, 224, 0.30);
}
