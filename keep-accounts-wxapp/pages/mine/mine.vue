...
.avatar-circle {
  ...
  box-shadow:
    ...
    0 8rpx 24rpx rgba(91, 130, 224, 0.25);
}
...
.year-card {
  ...
  border-radius: 24rpx;
  padding: 28rpx 32rpx;
  box-shadow: 0 2rpx 4rpx rgba(45, 49, 66, 0.04), 0 12rpx 36rpx rgba(123, 158, 245, 0.16);
  position: relative;
  z-index: 2;
}
...
.menu-card {
  ...
  border-radius: 24rpx;
  overflow: hidden;
  box-shadow: 0 1rpx 2rpx rgba(45, 49, 66, 0.04), 0 6rpx 22rpx rgba(123, 158, 245, 0.08);
}
...
.menu-item {
  ...
  padding: 32rpx 32rpx;
  border-bottom: 1rpx solid rgba(45, 49, 66, 0.04);
}
...
.login-btn {
  ...
  box-shadow:
    ...
    0 6rpx 20rpx rgba(123, 158, 245, 0.32);
}
...
.login-btn:active {
  ...
  box-shadow:
    ...
    0 2rpx 8rpx rgba(91, 130, 224, 0.25);
}
...
.edit-panel {
  ...
  box-shadow: 0 -8rpx 32rpx rgba(123, 158, 245, 0.18);
}
...
.save-btn {
  ...
  box-shadow:
    inset 0 1rpx 0 rgba(255, 255, 255, 0.3),
    0 4rpx 14rpx rgba(123, 158, 245, 0.3);
}
