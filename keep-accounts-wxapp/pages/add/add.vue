...
.type-item.active {
  ...
  box-shadow:
    ...
    0 4rpx 16rpx rgba(123, 158, 245, 0.32);
}
...
.amount-line {
  height: 1rpx;
  background: linear-gradient(90deg, transparent 0%, rgba(45,49,66,0.10) 50%, transparent 100%);
  margin-bottom: 24rpx;
}
...
.key {
  ...
  color: #2D3142;
  font-weight: 500;
  box-shadow: 0 1rpx 2rpx rgba(45, 49, 66, 0.04), 0 2rpx 8rpx rgba(123, 158, 245, 0.05);
...
.key-confirm {
  ...
  box-shadow:
    inset 0 1rpx 0 rgba(255, 255, 255, 0.3),
    inset 0 -2rpx 6rpx rgba(91, 130, 224, 0.20),
    0 6rpx 18rpx rgba(123, 158, 245, 0.32);
}
